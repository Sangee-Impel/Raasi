...
Vue.component('manage-other-accessories', {
    ...
    methods : {
        ...
        onAction (action, data, index) {
            ...
            switch (action) {
                case 'edit-item':
                    axios.get('/api/other-accessories/'+data.id)
                        .then(response => {
            ...
            swal({
                    title: "Are you sure?",
                    text: "Other Accessories  will be Restored!",
                    icon: "warning",
                     buttons: true,
                     dangerMode: true,
                }).then(isConfirm =>{
                if (isConfirm) {
                    axios.get('/api/other-accessories/restore/'+data.id)
                        .then(response => {
                        console.log(response);
            ...
            swal({
                    title: "Are you sure?",
                    text: "Other Accessories will be deleted!",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                }).then(isConfirm =>{
                if (isConfirm) {
                    axios.delete('/api/other-accessories/'+data.id +"?trash="+this.vueTableParams.trash)
                        .then(response => {
                ...
                .catch(reason => {
                    self.$snotify.error('Cannot delete Other Accessories');
