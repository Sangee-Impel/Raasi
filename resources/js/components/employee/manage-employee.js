...
Vue.component('manage-employee', {
    ...
    methods : {
        ...
        onAction (action, data, index) {
            ...
            switch (action) {
                case 'edit-item':
                    axios.get('/api/employee/'+data.id)
                        .then(response => {
            ...
            swal({
                    title: "Are you sure?",
                    text: "Employee  will be Restored!",
                    icon: "warning",
                     buttons: true,
                     dangerMode: true,
                }).then(isConfirm =>{
                if (isConfirm) {
                    axios.get('/api/employee/restore/'+data.id)
                        .then(response => {
                        console.log(response);
            ...
            swal({
                ...
                if (isConfirm) {
                    axios.delete('/api/employee/'+data.id +"?trash="+this.vueTableParams.trash)
                        .then(response => {
                ...
                .catch(reason => {
                    self.$snotify.error('Cannot delete Employee');
