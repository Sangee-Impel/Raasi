                                                    ...
                                                    <div class="three fields">
                                                        ...
                                                        <div class="field">
                                                            ...
                                                            <v-select
                                                                placeholder="Status"
                                                                v-model="status"
                                                                :options="types.transaction_item_loss_status"
                                                                :searchable="true"
                                                                :multiple="false"
                                                                label="name"
                                                                track-by="id"
                        ...
                        <div class="row center">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12 center">
                                <vue-table ref="vuetable"
                                           api-url="{{ URL::route('loss-approval.index') }}"
                                           :fields="fields"
                                           pagination-path=""
                                ...
                                >
                                    <template slot="actions" scope="props">
                                        <div class="custom-actions">
                                            ...
                                            <button class="btn btn-icon green" v-if="checkLossStatus(props.rowData.status)"
                                                    @click="openReasonModelPopup(props.rowData)">
                                                ...
                                                <form class="ui form  fix-sui">
                                                    <div class="three fields">
                                                        <div class="field">
                                                            ...
                                                            <v-select
                                                                ...
                                                                :options="types.loss_reason_type"
                                                                :searchable="true"
                                                                :multiple="false"
                                                                label="name"
                                                                track-by="id"
                                                            ...
                                                            <div class="ui pointing red basic label"
                                                                 v-show="form.errors.has('reason_type_id')">
                                                    ...
                                                    <div class="field" v-if="checkReasonStatus">
                                                        <div class="one field">
                                                            ...
                                                            <div class="ui pointing red basic label"
                                                                 v-show="form.errors.has('loss_description')">
