...
@section('content')
<manage-split-report inline-template>
    <div class="padding">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row center">
                            @permission('index.splitreport')
                            <div class="col-sm-12 col-md-12 col-lg-12 center">
                                <vue-table ref="vuetable" api-url="{{ URL::route('split-report.index') }}" :fields="fields" pagination-path="" :http-fetch="vueTableFetch" @vuetable:pagination-data="onPaginationData" :append-params="vueTableParams">
                                </vue-table>
                                <table class="ui blue selectable celled stackable attached table">
                                    <tfoot class="vuetable-body">
                                        <tr>
                                            <td style="text-align: right; width: 57.4%;">Total</td>
                                            <td style="width: 25.2%;">
