...
@section('content')
<manage-fctransaction-report inline-template>
    <div class="padding">
                    ...
                    <div class="box-header">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="row p-3">
                                    <div class="col-lg-2 ">
                                        <h2 class="pt-3">Fc transaction Report</h2>
                                    </div>
                                    <div class="col-lg-10">
                    ...
                    <div class="box-body">
                        <div class="row center">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12 center">
                                <vue-table ref="vuetable" api-url="{{ URL::route('fctransaction-report.index') }}" :fields="fields" pagination-path="" :http-fetch="vueTableFetch" @vuetable:pagination-data="onPaginationData" :append-params="vueTableParams">
                                </vue-table>
