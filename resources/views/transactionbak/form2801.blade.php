                                                            ...
                                                            <div class="table-hover scroll-x" >
                                                                <table class="ui celled table ">
                                                                    ...
                                                                    <tr   v-for="(transaction_item,index) in transaction_items" @click="showStyleModel(index)" :class="( viewedStyleIndex == index )?'active':''">
                                                                        ...
                                                                        <td>
                                                                            <input type="text" v-model="transaction_item.receive_weight"  placeholder="weight" >
                                            ...
                                            <div class="col-lg-12">
                                                <div class="box m-2">
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        {{--sangeetha--}}
                                                        <div class="text-right p-t-sm" v-if="form.transaction_item_loss_detail_status != true">
                                                            <button class="ui button medium yellow"  @click="showLossDetailModel(index)" type="button">Add Loss/Scrap</button>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <sui-modal-content scrolling>
                                    <sui-modal-description>
                                        <div class="ui message ">
                                            <div class="row  mt-3">
                                                <div class="col-lg-12">
                                                    <v-gallery :images="bag_style_images_view"  >
                                                </div>
                                            </div>
                                        </div>
                                    </sui-modal-description>
