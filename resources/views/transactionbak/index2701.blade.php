                            ...
                            <div class="col-lg-10">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        @endpermission-->
                                        @permission('store.transaction')
                                        <button class="btn btn-fw info pull-right mr-4" @click="showForm">Create</button>
                                        @endpermission
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row center">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12 center">
                                <vue-table ref="vuetable"
                                           api-url="{{ URL::route('transaction.index') }}"
                                           :fields="fields"
                                           pagination-path=""
                                ...
                                >
                                    <template slot="actions" scope="props">
                                        <div class="custom-actions">
                                            ...
                                            @permission('restore.transaction')
                                            ...
                                            @endpermission
                                            <!--@permission('destroy.transaction')
                                ...
                                <div class="box-header">
                                    <div class="row">
                                        <div class="col-lg-8 offset-lg-2">
                                            <div class="row">
                                                <div class="col-lg-8 ">
                                                    <h2 class="pt-1">@{{ formTitle }} Transaction</h2>
                                                </div>
                                                <div class="col-lg-4 ">
