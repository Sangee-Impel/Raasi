                                ...
                                <div class="two fields">
                                    <div class="field">
                                        ...
                                        <div class="ui action input">
                                            <v-select v-model="selected_bag" open-direction="bottom" :options="bag_options" :searchable="true" :internal-search="false" :clear-on-select="false" :multiple="false" :loading="multiLoading" label="bag_number" :options-limit="7" :limit="5" @search-change="loadBags" @input="changeBag()" track-by="id" placeholder="Type 2 more characters to search "></v-select>
                                    ...
                                    <div class="field custom_date">
                                        ...
                                        <v-date-picker v-model="form.transaction_date" class="date-picker-customize" enable-button-validate format="YYYY-MM-DD" formatted="D MMM YYYY" label=" " only-date auto-close title="Payment date">
                                        </v-date-picker>
                                        <div class="ui pointing red basic label" v-show="form.errors.has('transaction_date')">
                            ...
                            <div class="col-lg-6">
                                <div class="two fields">
                                    <div class="field">
                                        ...
                                        <v-select placeholder="Department" v-model="from_department" :options="from_department_options" :searchable="true" :multiple="false" label="name" track-by="id" :disabled="displayStatus.from_dep" :show-labels="true" @input="loadDropDownData('from_department')"></v-select>
                                        <div class="ui pointing red basic label" v-show="form.errors.has('from_department_id')">
                                            @{{ form.errors.get('from_department_id') }}
                                        </div>
                                    </div>
                                    <div class="field">
                                        <label class="text-black">To</label>
                                        <v-select placeholder="Department" v-model="to_department" :options="to_department_options" :searchable="true" :multiple="false" label="name" track-by="id" :show-labels="false" :disabled="displayStatus.to_dep" @input="loadDropDownData('to_department')"></v-select>
                                        <div class="ui pointing red basic label" v-show="form.errors.has('to_department_id')">
                                ...
                                <div class="two fields">
                                    <div class="field">
                                        <v-select placeholder="Employee" v-model="from_employee" :options="from_employee_options" :searchable="true" :multiple="false" label="name" track-by="id" :disabled="displayStatus.from_emp" :show-labels="false" :custom-label="customEmployeeLabel" @input="clearBagData()"></v-select>
                                        <div class="ui pointing red basic label" v-show="form.errors.has('from_employee_id')">
                                            @{{ form.errors.get('from_employee_id') }}
                                        </div>
                                    </div>
                                    <div class="field">
                                        <v-select v-model="to_employee" placeholder="Employee" :options="to_employee_options" :searchable="true" :multiple="false" label="name" track-by="id" :show-labels="false" :custom-label="customEmployeeLabel" :disabled="displayStatus.to_emp"></v-select>
                                        <div class="ui pointing red basic label" v-show="form.errors.has('to_employee_id')">
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <button class="ui inverted yellow button pull-right" type="button" v-if="isAllowedToSplitOrMerge && (displayMode.transfer_item_mode)" @click="showLossDetailModel(1)">Add Scrap</button>
                                                                    ...
                                                                    <tbody>
                                                                        <tr v-for="(transaction_item,index) in transaction_items" @click="showStyleModel(index)" :class="( viewedStyleIndex == index )?'active':''">
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <div v-else>
                                                                                    <v-select v-model="transaction_item.other_accessories" :options="other_accessories_options" :searchable="true" :multiple="false" label="name" track-by="id" :show-labels="false" @input="bindAccessories(index)"></v-select>
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="two fields">
                                                                            <div class="field">
                                                                                ...
                                                                                <div class="ui action input">
                                                                                    <v-select v-model="merge_selected_bag" open-direction="bottom" :options="merge_bag_options" :searchable="true" :internal-search="false" :clear-on-select="false" :multiple="false" :loading="multiLoading" label="bag_number" :options-limit="7" :limit="5" @search-change="loadMergeBags" track-by="id" placeholder="Type 2 more characters to search "></v-select>
                                                                                </div>
                                                                            </div>
                                                                            <div class="field">
                                ...
                                <div class="row mt-3">
                                                                ...
                                                                <table class="ui celled table ">
                                                                    ...
                                                                    <tbody>
                                                                        <tr v-for="(transaction_item_loss_detail,lossDetailIndex) in selectedTransferItem.transaction_item_loss_details">
                                                                            <td>
                                                                                <v-select placeholder="Type" v-model="transaction_item_loss_detail.type_drop_down" :options="types.transaction_item_loss_type" :searchable="true" :multiple="false" label="name" track-by="id" deselect-label="Can't remove this value" :allow-empty="false" @input="checkWastageType(lossDetailIndex)" :disabled="true"></v-select>
                                                                            </td>
                                                                            <!--<td>
                                                                    <v-select
                                    ...
                                    <sui-modal v-model="display_scrap_details">
                                        <sui-modal-header>Transfer Item Scrap Details</sui-modal-header>
                                        <sui-modal-content scrolling>
                                            <sui-modal-description>
                                                <div class="ui message ">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    @{{checkTotalScrapLossWeight}}
                                                                    Max allowed Scrap Weight @{{selectedTransferItem.remaining_loss}}
                                                                </div>
                                                                <!--<div class="col-lg-6">
                                                            <button class="ui inverted primary button pull-right" type="button" @click="addTransferItemLossAndScrapItem()">Add Loss/Scrap</button>
                                                        </div>-->
                                                    ...
                                                    <div class="row  mt-3">
                                                        <div class="col-lg-12">
                                                            <div class="table-hover">
                                                                <table class="ui celled table scrap_custom_table">
                                                                    <thead>
                                                                        <tr>
                                                                            <td>Type</td>
                                                                            <td>Quantity</td>
                                        ...
                                        <sui-modal-actions>
                                            <button class="ui button medium green" @click="saveScrapDetailModel" type="button">Save</button>
                                            <button class="ui button medium" @click="closeScrapDetailModel" type="button">Cancel</button>
                                        </sui-modal-actions>
                                    </sui-modal>
