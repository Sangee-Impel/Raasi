                                    ...
                                    >
                                        <template slot="actions" scope="props">
                                            <div class="custom-actions">
                                                ...
                                                <button  v-if="checkEditStatus(props.rowData)"  class="btn btn-icon indigo"
                                                ...
                                                @endpermission-->
                                                @permission('index.bag')
                                                <button class="btn btn-icon orange"
                                                        @click="onAction('view-item', props.rowData, props.rowIndex, props)">
                                                    <i class="fa fa-eye"></i>
                                                </button>
                                                @endpermission
                                                @permission('cancel.bag')
                                                <button class="btn btn-icon red" v-if='props.rowData.status == types.findBagType("in_progress","value","bag_status")["id"]'
                                                        @click="onAction('cancel-item', props.rowData, props.rowIndex, props)">
                                            ...
                                            <div class="col-lg-12"  v-hotkey="keymap">
                                                <form class="ui form  fix-sui">
                                                        ...
                                                        <div class="fields ui grid">
                                                            <div class="sixteen wide column">
                                                                <h4 class="ui horizontal divider header medium p-2 border-bottom-none">
                                                                    ...
                                                                    Add Style's
                                                                    <button class="ui button" type="button" v-if="!isViewMode"
                                                                            @click="addStyle()"
                                                                            v-if="form.bag_styles.length == 0">Add a style (Ctrl+Enter)</button>
                                                                </h4>
                                                                        ...
                                                                        <div class="field">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-lg-2">
                                                                                    ...
                                                                                    <profile-file-pond  v-if=" bag_style.upload_id == null && (!isViewMode)"
                                                                                                        name="attachment"
                                                                                                        ref="pond"
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="field col-lg-6" v-if="bag_style.other_accessories == null">
                                                                                            ...
                                                                                            <v-select
                                                                                                ...
                                                                                                :options-limit="7"
                                                                                                :limit="5"
                                                                                                @search-change="loadStyles"
                                                                                                @input="changeBagStyle(index)"
                                                                                                track-by="id"
                                                                                                placeholder="Type 2 more characters to search "
                                                                                                :disabled="isViewMode"
                                                                                            ></v-select>
                                                                                        ...
                                                                                        <div class="field col-lg-6" v-else>
                                                                                            ...
                                                                                            <v-select
                                                                                                v-model="bag_style.other_accessories"
                                                                                                :options="styleOptions"
                                                                                                label="name"
                                                                                                :disabled="isViewMode"
                                                                                            ></v-select>
                                                                ...
                                                                <h4 class="ui horizontal divider header medium p-2 border-bottom-none"
                                                                    v-if="form.bag_styles.length > 0 && !(isViewMode)" >
                                                    ...
                                                    <div class="field">
                                                        <div class="one field">
                                                            <label>Instructions</label>
                                                            <vue-editor name="description" v-model="form.instructions" :disabled="isViewMode"></vue-editor>
